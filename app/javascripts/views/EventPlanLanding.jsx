...
var EventPlanLanding = React.createClass({
	...
	render: function() {
		...
		var categoryNames = []
		var categoryLinks = []
		var industries = ["Events", "Equipment", "Creative", "Business"];

		industries.sort()
		Data.categories.forEach(function(item) {
			if(item.industry=="Events"||item.industry=="Equipment"||item.industry=="Creative"||item.industry=="Business") {
		...
		return (
			<div className="EventPlanLanding">
				<Banner title="Planning an event?" bgurl="assets/categories/eventplanning.jpg">
				...
				<div className="section gray-panel-2 break">
					<div className="row page-panel">
						<div className="large-12 columns">
							<h2 className="break-end" >Browse all categories for event planning</h2>
						</div>
					</div>				
					<div className="row">
...
module.exports = EventPlanLanding;
